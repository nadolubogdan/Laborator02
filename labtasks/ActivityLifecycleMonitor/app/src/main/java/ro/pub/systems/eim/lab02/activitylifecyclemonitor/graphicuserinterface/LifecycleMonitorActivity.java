...
import static ro.pub.systems.eim.lab02.activitylifecyclemonitor.general.Constants.TAG;
...
public class LifecycleMonitorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            Log.d(TAG, "onCreate: method was invoked without previous lifecycle");
        } else {
            Log.d(TAG, "onCreate: method was invoked with previous lifecycle");
            /*
